...
if ($_SERVER["REQUEST_METHOD"] == 'POST'){
    ...
    if (isFormValidated()){
        ...
        $admin = [];
        $admin['username'] = htmlspecialchars($_POST['username'], ENT_QUOTES);
        $admin['password'] = sha1($_POST['password']);
        $admin['fullname'] = htmlspecialchars($_POST['fullname'], ENT_QUOTES);
        $admin['email'] = htmlspecialchars($_POST['email'], ENT_QUOTES);
        $admin['contact'] = htmlspecialchars($_POST['contact'], ENT_QUOTES);
        $admin["pre_username"] = htmlspecialchars($_POST["pre_username"], ENT_QUOTES);
